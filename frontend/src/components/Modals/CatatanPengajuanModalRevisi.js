...
const CatatanPengajuanModalRevisi = ({ showModal, setShowModal, id, statusToChange }) => {
    ...
    return (
      <div className={`modal fade ${showModal ? 'show' : ''}`} id="catatanPengajuanModalRevisi" tabIndex="-1" aria-labelledby="editKAKModalLabel" aria-hidden={!showModal}>
  ...
  export default CatatanPengajuanModalRevisi;