...
const AccProkerModal = ({ showModal, setShowModal, handleSubmit, selectedProkerId, selectedStatus, reloadData }) => {
    const [catatan, setCatatan] = useState('');
    const [tahap, setTahap] = useState('');
    const role = localStorage.getItem('role');
    const modalRef = useRef();

    console.log(selectedProkerId);
    ...
    const handleRevisiSubmit = (e) => {
        ...
        console.log("Tahap: ", tahapValue);
        axios.post('/api/proker/verifikasi/revisi', {
            id_proker: selectedProkerId,
            catatan: catatan,
            tahap: tahapValue // Use the updated value
        })
            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="pesanModalLabel">Masukan Catatan untuk Proker</h5>
