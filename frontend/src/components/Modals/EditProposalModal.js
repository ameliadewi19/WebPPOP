...
const EditProposalModal = ({ reloadData, selectedProkerId }) => {
    ...
    return (
        <div className={`modal fade`} id="editProposalModal" tabIndex="-1" aria-labelledby="editProposalModalLabel" aria-hidden={!showModal}>
            <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title" id="editProposalModalLabel">Pengajuan Proposal</h5>
