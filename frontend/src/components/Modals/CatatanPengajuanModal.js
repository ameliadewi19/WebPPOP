...
const CatatanPengajuanModal = ({ showModal, setShowModal, id, statusToChange }) => {
    ...
    return (
      <div className={`modal fade ${showModal ? 'show' : ''}`} id="catatanPengajuanModal" tabIndex="-1" aria-labelledby="editKAKModalLabel" aria-hidden={!showModal}>
  ...
  export default CatatanPengajuanModal;