...
const EditKAKModal = ({ showModal, setShowModal }) => {
    ...
    return (
      <div className={`modal fade ${showModal ? 'show' : ''}`} id="editKAKModal" tabIndex="-1" aria-labelledby="editKAKModalLabel" aria-hidden={!showModal}>
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="editKAKModalLabel">Edit KAK</h5>
